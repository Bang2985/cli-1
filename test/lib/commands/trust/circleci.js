...
t.test('bodyToOptions with all fields', t => {
  ...
  t.equal(options.contextId, '123e4567-e89b-12d3-a456-426614174000', 'contextId should be set')
  t.end()
})

t.test('bodyToOptions without optional context_id', t => {
  const TrustCircleCI = require('../../../../lib/commands/trust/circleci.js')
  ...
  t.equal(options.contextId, undefined, 'contextId should be undefined')
  t.end()
})
...
t.test('optionsToBody with all fields', t => {
  ...
  t.equal(body.claims.context_id, '123e4567-e89b-12d3-a456-426614174000', 'context_id should be set')
  t.end()
})

t.test('optionsToBody without optional contextId', t => {
  const TrustCircleCI = require('../../../../lib/commands/trust/circleci.js')
  ...
  t.equal(body.claims.context_id, undefined, 'context_id should be undefined')
  t.end()
})
